...
import { MsMenubar } from "maxi-react-components";
import maxilogo from "../../assets/maxi.svg";
...
const Menubar = () => {
  ...
  const handleMenuActiveItemId = (e: any) => {
    console.log("action", e.detail);
    setOptionActive(e.detail.id);
  };
  return (
    <>
      <MsMenubar items={items} menuActiveItemId={optionActive}>
        <img slot="start" src={maxilogo} alt="Maxi Logo" />

        <div slot="end">
          <div style={{ display: "flex", gap: "20px" }} slot="end">
